        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ActivityTimeout = table.Column<TimeSpan>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expiration = table.Column<TimeSpan>(type: "TEXT", nullable: true),
                    MaxAge = table.Column<TimeSpan>(type: "TEXT", nullable: true),
