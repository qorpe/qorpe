...
public interface IApplicationDbContext
{
    ...
    public DbSet<ClusterConfigMetadata> ClusterConfigMetadata { get; }
    public DbSet<Destination> Destinations { get; }
    public DbSet<DestinationConfig> DestinationConfigs { get; }
    public DbSet<DestinationConfigMetadata> DestinationConfigMetadata { get; }
    ...
    public DbSet<RouteConfigMetadata> RouteConfigMetadata { get; }
    ...
    public DbSet<TransformMetadata> TransformMetadata { get; }
